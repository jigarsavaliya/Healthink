...
public class ComboDaysAdapter extends RecyclerView.Adapter<ComboDaysAdapter.ViewHolder> {

    ArrayList<ArchivementModel> mDailyStepDatalist;
    Activity activity;
    int StepGoal;

    public ComboDaysAdapter(ArchivementActivity mainActivity, ArrayList<ArchivementModel> archivementModels) {
