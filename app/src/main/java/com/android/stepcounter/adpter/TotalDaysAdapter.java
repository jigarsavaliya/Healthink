...
public class TotalDaysAdapter extends RecyclerView.Adapter<TotalDaysAdapter.ViewHolder> {

    ArrayList<ArchivementModel> mDailyStepDatalist;
    Activity activity;
    int StepGoal;

    public TotalDaysAdapter(ArchivementActivity mainActivity, ArrayList<ArchivementModel> archivementModels) {
