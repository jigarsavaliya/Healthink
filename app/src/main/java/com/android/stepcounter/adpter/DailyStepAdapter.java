...
public class DailyStepAdapter extends RecyclerView.Adapter<DailyStepAdapter.ViewHolder> {

    ArrayList<ArchivementModel> mDailyStepDatalist;
    Activity activity;
    int StepGoal;

    public DailyStepAdapter(ArchivementActivity mainActivity, ArrayList<ArchivementModel> archivementModels) {
