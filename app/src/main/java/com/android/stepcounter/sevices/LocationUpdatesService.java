...
public class LocationUpdatesService extends Service {
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && CommanMethod.requestingLocationUpdates(this)) {
    ...
    public void requestLocationUpdates() {
        ...
        CommanMethod.setRequestingLocationUpdates(this, true);
        startService(new Intent(getApplicationContext(), LocationUpdatesService.class));
        try {
            mFusedLocationClient.requestLocationUpdates(mLocationRequest,
                    mLocationCallback, Looper.myLooper());
        } catch (SecurityException unlikely) {
            CommanMethod.setRequestingLocationUpdates(this, false);
    ...
    private Notification getNotification() {
        ...
        CharSequence text = CommanMethod.getLocationText(mLocation);
